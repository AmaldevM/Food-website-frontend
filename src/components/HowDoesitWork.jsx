...
export const HowDoesitWork = () => {
  return (
            ...
            <div className="text-center shadow-lg transition-transform duration-200 ease-in-out hover:scale-[1.05] rounded-xl gap-4">
                ...
                <ul className="md:grid md:grid-cols-3 md:col-gap-10 md:row-gap-10 shadow-lg transition-transform duration-200 ease-in-out hover:scale-[1.05] rounded-xl gap-4">
                    <li className=" bg-gray-100 p-5 pb-10 text-center rounded-xl">
                        <div className="flex flex-col items-center">
                            <div className="flex-shrink-0 relative top-0 -mt-16">
                                <div
                                    className="flex items-center justify-center h-20 w-20 rounded-full bg-amber-500 text-white border-4 border-white text-xl font-semibold ">
                                    1
                                </div>
                            </div>
                            <div className="mt-4">
                                <h4 className="text-lg leading-6 font-semibold text-gray-900">Easy to Order</h4>
                    ...
                    <li className=" bg-gray-100 p-5 pb-10 text-center rounded-xl">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mt-4">
                                <h4 className="text-lg leading-6 font-semibold text-gray-900">Fastest Delivery</h4>
                                <p className="mt-2 text-base leading-6 text-gray-500">
                    ...
                    <li className=" bg-gray-100 p-5 pb-10 text-center rounded-xl ">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mt-4">
                                <h4 className="text-lg leading-6 font-semibold text-gray-900">Best Quality</h4>
                                <p className="mt-2 text-base leading-6 text-gray-500">
